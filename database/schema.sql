...
-- Updated: 2026-03-31
-- Canonical schema matching the live production database.
...
-- Active embedding model: BAAI/bge-base-en-v1.5 (768 dimensions)
...
-- Legacy 384-dim tables from all-MiniLM-L6-v2 (retained, not actively used)

CREATE VIRTUAL TABLE vec_memories_384 USING vec0(
    memory_id INTEGER PRIMARY KEY,
    embedding FLOAT[384]
);

CREATE VIRTUAL TABLE vec_facts_384 USING vec0(
    fact_id INTEGER PRIMARY KEY,
    embedding FLOAT[384]
);
